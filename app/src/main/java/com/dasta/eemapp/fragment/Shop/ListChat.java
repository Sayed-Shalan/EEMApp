...
import com.dasta.eemapp.fragment.Client.ChatListAdapter;
...
public class ListChat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        userid = shopData.get("shopid");
        username = shopData.get("shopname");
                ...
                public void onclick(View child, int position) {
                    ...
                    if (bundle!=null){
                        if (bundle.getBoolean("home",false)){
                            ...
                            ShopChat clientChatRoom = new ShopChat();
                            ...
                            ft.replace(R.id.fShopChatLayout, clientChatRoom);
                            ft.commit();
