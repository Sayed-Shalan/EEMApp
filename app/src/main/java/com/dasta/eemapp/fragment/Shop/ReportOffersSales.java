...
public class ReportOffersSales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_shop_report_offers, null, false);
        flag = 1;
        table_layout = (TableLayout) v.findViewById(R.id.tableLayout3);
        ...
        if(isNetworkAvailable()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, AppConfig.URL_SHOP_REPORT_OFFERS,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    tv3.setText(shop.getString("sale_price"));
                                    row.addView(tv3);
                                    ...
                                    tv4.setText(shop.getString("sale_percentage"));
                                    row.addView(tv4);
