...
public class ReportReservation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_shop_report_reservation, null, false);
        ...
        if (isNetworkAvailable()) {
            StringRequest request = new StringRequest(Request.Method.POST, AppConfig.URL_SHOP_REPORT_RESERVATION,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    tv2.setText(shop.getString("product_quantity"));
                                    row.addView(tv2);
                                    ...
                                    tv3.setText(shop.getString("reservation_num"));
                                    row.addView(tv3);
