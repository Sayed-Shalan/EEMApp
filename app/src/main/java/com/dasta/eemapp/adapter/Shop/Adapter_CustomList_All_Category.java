 ...
 */
public class Adapter_CustomList_All_Category extends BaseAdapter implements View.OnClickListener {
    ...
    public Adapter_CustomList_All_Category(Activity a, ArrayList d, Resources resLocal, Category activityfrag) {

        /********** Take passed values **********/
        activity = a;
        data = d;
        res = resLocal;
        category = activityfrag;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.row_list_all_category, parent, false);
            ...
            holder.imgDel = (ImageView) vi.findViewById(R.id.imgShopCategoryDel);
    ...
    private class OnItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            if (data.size() <= 0) {
                ...
                category.onItemClick(mPosition);
            }
        }
    }
