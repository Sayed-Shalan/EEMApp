 ...
 */
public class Adapter_CustomList_All_Client_Chat extends BaseAdapter implements View.OnClickListener {

    private Activity activity;
    private ClientChat lst;
    ...
    public Adapter_CustomList_All_Client_Chat(Activity a, ArrayList d, Resources resLocal, ClientChat lstC) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (data.size() <= 0) {
            ...
            holder.txtName.setText(tempValues.getReceiverName());
